...
void RK4::operator()(System& system,
                     const SystemField& u0,
                     SystemView_Mutable u,
                     ...
                     real dt)
{
    ...
    for (int i = 0; i < 4; ++i) {
        if (i > 0) {
            ...
            // of boundary values.  Should they all be packaged up in a "SystemField?"
            ...
            // a lot of information in the SystemField that might better
