...
TEST_CASE("plane_view")
{
    ...
    REQUIRE(x == std::vector<int3>{T{0, 0, 0},
                                   ...
                                   T{0, 1, 2},
                                   T{0, 1, 3}});
    REQUIRE(index_view<0>(extents, -1) ==
    ...
    REQUIRE(index_view<1>(extents, 0) ==
            std::vector<int3>{T{0, 0, 0},
                              ...
                              T{2, 0, 2},
                              T{2, 0, 3}});
    REQUIRE(index_view<1>(extents, -1) ==
    ...
    REQUIRE(index_view<2>(extents, 0) ==
            std::vector<int3>{
                T{0, 0, 0}, T{0, 1, 0}, T{1, 0, 0}, T{1, 1, 0}, T{2, 0, 0}, T{2, 1, 0}});
    REQUIRE(index_view<2>(extents, -1) ==
            std::vector<int3>{
