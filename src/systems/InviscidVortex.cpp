...
void InviscidVortex::operator()(SystemField&, const StepController&) {}

SystemStats
InviscidVortex::stats(const SystemField&, const SystemField&, const StepController&) const
{
    return {};
}

bool InviscidVortex::valid(const SystemStats&) const { return false; }
...
void InviscidVortex::update_boundary(SystemView_Mutable, real) {}

void InviscidVortex::log(const SystemStats&, const StepController&)
{
...
SystemStats euler_vortex::stats(real time)
{
    this->stats_(stats0,
