...
TEST_CASE("gauss1d - lua")
{
    ...
    auto ms_opt = ManufacturedSolution::from_lua(lua["simulation"], 1);
    REQUIRE(!!ms_opt);
    auto& ms = *ms_opt;
...
TEST_CASE("gauss2d - lua")
{
    ...
    auto ms_opt = ManufacturedSolution::from_lua(lua["simulation"], 2);
    REQUIRE(!!ms_opt);
    auto& ms = *ms_opt;
...
TEST_CASE("gauss3d - lua")
{
    ...
    auto ms_opt = ManufacturedSolution::from_lua(lua["simulation"], 3);
    REQUIRE(!!ms_opt);
    auto& ms = *ms_opt;
